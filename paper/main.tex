...
rate and how it was chosen (same sweep for every arm), seeds, hardware: every experiment ran on NVIDIA T4
GPUs (16\,GB) on a public cloud notebook service; post-hoc truncation in float32, pretraining and conversion
in float16 with loss scaling, because the T4 has no native bfloat16. Full hyperparameters go in the appendix.}
